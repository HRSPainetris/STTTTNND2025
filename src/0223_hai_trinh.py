...
class Ui_MainWindow(object):
    def setupUi(self, Trip_Information):
        ...
        self.from_box.setGeometry(QtCore.QRect(20, 80, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        ...
        self.to_box.setGeometry(QtCore.QRect(190, 80, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        ...
        self.trongtinh_check.setGeometry(QtCore.QRect(20, 30, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        ...
        self.lientinh_check.setGeometry(QtCore.QRect(190, 30, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        ...
        self.to_label.setGeometry(QtCore.QRect(190, 60, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        ...
        self.from_label.setGeometry(QtCore.QRect(20, 60, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        ...
        self.newtrip_button.setGeometry(QtCore.QRect(20, 120, 161, 41))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
    ...
    def retranslateUi(self, Trip_Information):
        ...
        self.to_box.setItemText(3, _translate("Trip_Information", "Bến Tre"))
        ...
        self.to_label.setText(_translate("Trip_Information", "To:"))
        self.from_label.setText(_translate("Trip_Information", "From:"))
        ...
        self.drowsiness_thread = threading.Thread(target=self.drowsiness_detection_thread, daemon=True)
    ...
    def OK_click(self):
        ...
        msg.setGeometry(400, 50, 200, 100)
        msg.setIcon(QtWidgets.QMessageBox.Information)
        msg.setText(f"Start: {start_value}, End: {end_value}")
        msg.setWindowTitle("Selected Values")
    ...
    def drowsiness_detection_thread(self):
        global set_time, start_time
...
if __name__ == "__main__":
    ...
    Trip_Information.setGeometry(325, 30, 363, 182)
