...
left_in_vid_name = "bridge_day_250114.mp4" # bridge
...
right_in_vid_name = "bridge_day_250114.mp4"
...
for i in tqdm(range(min(left_cam_nframes, right_cam_nframes))):
    left_cam_buffer.append(cv2.resize(cv2.flip(left_cam.read()[1],0),(640,320)))
